...
\begin{resume}
	...
	Gartenstra\ss{}e 49											\hfill mobile: on request									\vspace{0mm}\\\vspace{0mm}%
	72074 T\"ubingen										\hfill e-mail: cofenberg@gmail.com	\vspace{0mm}\\\vspace{0mm}%
	Germany													\hfill Online: http://www.ablazespace.de	\vspace{0mm}\\\vspace{-4.5mm}%
	...
	\textbf{Software developer at Promotion Software GmbH} \hfill \textbf{September 2012 -- present}\vspace{-3mm}\\\vspace{-1mm}%
	\begin{list2}
		...
		\item Concrete projects: EMERGENCY 5, EMERGENCY 2016, EMERGENCY 2017, EMERGENCY 20, TEAMWORK research project ( https://www.teamworkprojekt.de/tcc/ ), non-public research and client projects using AR (HoloLens) and VR (Oculus Rift and HTC Vive), unannounced game project using Unreal Engine 4
	\end{list2}\vspace{-1.5mm}
	\textbf{Unrimp - Free open-source 3D rendering project} \hfill \textbf{June 2012 -- present}\vspace{-3mm}\\\vspace{-1mm}%
	\begin{list2}
	...
	\end{list2}\vspace{-1.5mm}
	\textbf{http://www.ablazespace.de} \hfill \textbf{1995 -- 2002}\vspace{-3mm}\\\vspace{-1mm}%
	\begin{list2}
	...
	Primarly:
	\begin{list2}
		\item C, C++, OpenGL, Direct3D 9-11 (12 only basics so far), Vulkan, OpenGL ES 3.0, GLSL, HLSL, Windows, Linux, Android (C API), C++ plugin development for Autodesk 3ds Max, CMake, Qt, Lua, OpenCL, Visual Studio, GCC, Doxygen, Subversion, Git, OOP and design patterns
	\end{list2}\vspace{-1.5mm}
	...
	Further worked with:
	\begin{list2}
		\item Java, C\#, Pascal, Amiga Basic, Assembler, Unreal Engine 4, Unity (I'am no Unity programmer and don't intent to become one) and the project management tool Hansoft to create tasks etc.
	\end{list2}\vspace{-1.5mm}
	...
	\begin{list2}
		\item German: Native
		\item English: I read and write in English on a daily basis. Watching movies etc. whenever possible on English only. Looking forward to getting more practice speaking English by myself.
	\end{list2}\vspace{-1.5mm}
	...
	\begin{list2}
		...
		\item Creating graphics demos and compositing scenes
		\item Sci-Fi/fantasy literature and video-games
		\item Hiking to relax
	\end{list2}\vspace{-1.5mm}
